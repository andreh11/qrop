...
APPIMAGE_FTP_FILE=${FTP_HOST}/httpdocs/${QROP_DIR}/${APPIMAGE_NAME}
DMG_NAME=${EXE_BASENAME}.dmg
DMG_FTP_FILE=${FTP_HOST}/httpdocs/${QROP_DIR}/${DMG_NAME}
WIN32_NAME=${EXE_BASENAME}-x86.exe
WIN32_FTP_FILE=${FTP_HOST}/httpdocs/${QROP_DIR}/${WIN32_NAME}
WIN64_NAME=${EXE_BASENAME}-x64.exe
WIN64_FTP_FILE=${FTP_HOST}/httpdocs/${QROP_DIR}/${WIN64_NAME}
