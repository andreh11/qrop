...
public:
    ...
    enum { DepthRole = Qt::UserRole - 4, ExpandedRole, HasChildrenRole, HasSiblingRole };
    ...
    Q_INVOKABLE const QModelIndex &mapToModel(const QModelIndex &index) const;
    ...
    void showModelChildItems(const TreeItem &parent, int start, int end, bool doInsertRows = true,
...
private slots:
    ...
    void modelDataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRigth,
                          const QVector<int> &roles);
    void modelLayoutAboutToBeChanged(const QList<QPersistentModelIndex> &parents,
                                     QAbstractItemModel::LayoutChangeHint hint);
    void modelLayoutChanged(const QList<QPersistentModelIndex> &parents,
                            QAbstractItemModel::LayoutChangeHint hint);
...
private:
    struct TreeItem {
        ...
        inline bool operator==(const TreeItem &other) const { return this->index == other.index; }
    };
